    ...
    email
      ...
      <div className='flex flex-col justify-end min-h-screen'>

        {
          show
          &&
          <div className='w-11/12 md:w-fit transition-all duration-300 flex justify-between gap-x-7 ease-in-out py-4 md:py-5 px-3 my-7 rounded-s-xl text-sm md:text-lg border-s-4 dark:border-none absolute top-4 right-0 z-10 bg-green-100 dark:bg-green-200 text-green-700 dark:text-green-950 border-s-green-700'>
        ...
        <div className='transition-all duration-300 ease-in-out w-80 md:w-96 shadow-lg md:shadow-xl shadow-zinc-300 dark:shadow-none border border-zinc-300 dark:border-zinc-500 rounded-lg py-16 md:py-20 px-6 mx-auto flex flex-col items-center gap-5 md:gap-6 absolute top-1/3 -translate-y-1/3 left-1/2 -translate-x-1/2'>
          ...
          <button
            ...
            disabled={isDisabled}
            className={`transition-colors duration-300 ease-in-out border border-zinc-400 dark:border-zinc-500 w-full py-3 md:py-4 rounded-lg text-zinc-600 dark:text-zinc-300 text-lg md:text-xl ${isDisabled ? 'cursor-not-allowed' : 'hover:text-zinc-800 dark:hover:text-zinc-100 hover:bg-white dark:hover:bg-zinc-900'}`}
          >
            Resend email
          </button>
        </div>
