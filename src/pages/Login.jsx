  ...
  return (
    <>
      <div className="flex flex-col min-h-screen">
        ...
        <form className='px-3 w-96 max-w-full mx-auto mt-16 flex-grow sm:m-0 sm:px-0 sm:w-96 sm:absolute sm:top-[45%] sm:left-[50%] sm:-translate-x-1/2 sm:-translate-y-1/2'>
          ...
          <div className='w-full flex justify-between items-center px-2 mt-8'>
            ...
            <input
              type="submit"
              value="Log in"
              className='bg-purple-700 hover:bg-purple-600 py-2 px-12 font-bold rounded-xl cursor-pointer'
            />
          </div>
        ...
        <div className='text-slate-500 text-sm text-center w-full pb-3 mt-20 sm:absolute sm:bottom-2 sm:right-1/2 sm:translate-x-1/2'>
