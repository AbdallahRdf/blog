...
function Card() {
  return (
    <Link to="/post" className='w-auto border border-slate-700 p-3 rounded-2xl hover:bg-zinc-800 transition-colors ease-in-out'>
        ...
        <p className='text-slate-400 border-s border-purple-500 ps-2  my-3'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odio, autem. Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, dolor?</p>
        <div className='flex gap-x-2'>
            {/* <SquareUser color="#ffffff" size={38} /> */}
            <img src={userAvatar} alt="user avatar" className='w-10' />
            <div>
