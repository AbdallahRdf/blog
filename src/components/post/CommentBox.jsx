...
function CommentBox() {
    ...
    return (
        <div className='relative flex items-start gap-3 my-6 '>
            ...
            {/* </button> */}
            <div>
                <p className='font-semibold text-lg mb-2'>@Username <span className='font-normal ps-2 text-base'>2days ago</span></p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores inventore repudiandae quae quam amet?</p>
                <div className='flex gap-5 mt-3'>
                    <button className='flex gap-x-2 items-center text-slate-100 hover:text-blue-500  p-1 rounded-md hover:bg-blue-950'>
                        <ThumbsUp size={18} className='inline' />
                        <span className='text-base'>234K</span>
                    </button>
                    <button className='flex gap-x-2 items-center text-slate-100 hover:text-rose-500 p-1 rounded-md hover:bg-rose-950'>
