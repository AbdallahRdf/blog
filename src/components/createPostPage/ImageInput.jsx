...
function ImageInput({ blockData, error, deleteBlock, handleBlockChange }) {
    ...
    return (
        <div id={id} className='flex flex-col mb-8 mt-6 px-3 relative'>
            <button type='button' onClick={deleteBlock} title='Delete Block' className='absolute top-1 right-4 text-zinc-500 dark:text-zinc-400 dark:hover:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-600 p-2 rounded-full'>
