...
function Footer() {
    return (
        <footer className="border-t border-t-purple-400 mt-8 sm:mt-12 pt-8 sm:pt-16 pb-6 px-9">
            <div className='mx-auto w-full xl:w-[1230px]'>
                ...
                <div className="flex justify-center sm:justify-between flex-wrap gap-5 my-6">
                    <p className='text-slate-300 text-base text-center sm:text-start sm:text-lg'><q>Learning and Growing One Line of Code at a Time.</q> <br /> Have feedback or ideas? Get in touch.</p>
                ...
                <p className='text-xs sm:text-sm text-center md:text-start md:text-base text-slate-400'>Radfi Abdallah &copy; 2024 | All rights reserved.</p>
            </div>
        </footer>
    )
}
